...
LOGGER = logging.getLogger("medical_datasets")
...
class MedicalTaskDataset(Dataset):
    ...
    def _load_or_compute_statistics(self) -> Dict[str, Any]:
        ...
        if self.statistics_path.exists() and self.histogram_path.exists():
    ...
    def _compute_statistics(self) -> Dict[str, Any]:
        ...
        for sample in self.samples:
            ...
            spacings.append(sample_spacings)
