...
from fomo26.paths import get_data_path, get_source_labels_path
...
class SegDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        foreground_locations = load_pickle(file.replace(".pt", ".pkl"))[
...
class SegTestDataset(Dataset):
    ...
    def _get_src_label(self, file, properties):
        ...
        src_label_path = file.replace(
            get_data_path(), get_source_labels_path()
        ).replace(".pt", "_label.nii.gz")
