...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(
        ...
        num_output_channels = plans_manager.get_label_manager(
            dataset_json
    ...
    def predict_from_data_iterator(
        ...
        with multiprocessing.get_context("spawn").Pool(
            ...
            ret = [None] * len(r)
            with tqdm(
                desc="Collecting results", total=len(r), disable=not self.allow_tqdm
            ) as pbar:
                for i, result in enumerate(r):
                    while True:
                        ...
                        if not all_alive:
                            raise RuntimeError(
                                "Segmentation export worker died. It was likely killed by "
