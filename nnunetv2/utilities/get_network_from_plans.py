...
def get_network_from_plans(
    ...
    architecture_kwargs = dict(**arch_kwargs) if arch_kwargs is not None else {}
...
if __name__ == "__main__":
    ...
    data = torch.rand((1, 3, 96, 96, 96), device="cuda", dtype=torch.float16)
