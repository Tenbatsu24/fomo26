...
class nnUNetPlannerResEncM(ResEncUNetPlanner):
    ...
    def __init__(
        ...
        if gpu_memory_target_in_gb != 8:
            warnings.warn(
                "WARNING: You are running nnUNetPlannerM with a non-standard gpu_memory_target_in_gb. "
...
class nnUNetPlannerResEncL(ResEncUNetPlanner):
    ...
    def __init__(
        ...
        if gpu_memory_target_in_gb != 24:
            warnings.warn(
                "WARNING: You are running nnUNetPlannerL with a non-standard gpu_memory_target_in_gb. "
...
class nnUNetPlannerResEncXL(ResEncUNetPlanner):
    ...
    def __init__(
        ...
        if gpu_memory_target_in_gb != 40:
            warnings.warn(
                "WARNING: You are running nnUNetPlannerXL with a non-standard gpu_memory_target_in_gb. "
