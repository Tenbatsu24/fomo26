...
def run_ddp(
    ...
    nnunet_trainer = get_trainer_from_args(
        ...
        tr,
        p,
        pretrained_from_scratch=pretrained_from_scratch,
    )
...
def run_training(
    ...
    if num_gpus > 1:
        ...
        # ToDo: Verify that continue training does not re-load the pretrained weights and overrides the
        #   Maybe load checkpoint call.
