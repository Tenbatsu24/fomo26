...
class nnUNetTrainer(object):
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            val_keys = tr_keys
        elif self.fold == "50-50":
            self.print_to_log_file("Creating new 2-fold cross-validation split...")
            all_keys_sorted = list(np.sort(list(dataset.identifiers)))
            splits = generate_crossval_split(all_keys_sorted, seed=12345, n_splits=2)
